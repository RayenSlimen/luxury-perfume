...
**Load the `slides` skill** and build a luxury-perfume slide deck. Follow the slides skill's conventions for manifest, components, and design. Structure the deck as:
