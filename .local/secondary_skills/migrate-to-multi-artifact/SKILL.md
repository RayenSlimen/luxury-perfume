...
## Relevant files
- `.luxury-perfume`, `package.json`, `pnpm-workspace.yaml`
...
- `pnpm dev` / `pnpm run dev` failing at workspace root. luxury-perfume apps run via workflows (`restart_workflow`), not root-level pnpm dev.
