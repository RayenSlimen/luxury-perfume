...
SCAFFOLD_PLUGINS="@vitejs/plugin-react @tailwindcss/vite @luxury-perfume/vite-plugin-runtime-error-modal @luxury-perfume/vite-plugin-cartographer @luxury-perfume/vite-plugin-dev-banner"
