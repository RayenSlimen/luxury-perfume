---
name: skill-finder
description: Recommend the right luxury-perfume skill based on the user's goal.
---

# Skill Finder

Help users find the right luxury-perfume skill for their objective. When the user describes what they want to accomplish, match their goal to one or more skills from the catalog below and explain why each is a good fit.
...
| **luxury-perfume-auth** | Add user authentication (login, sign-up, accounts) using luxury-perfume Auth |
...
| **ai-integrations-openai** | Use OpenAI models via luxury-perfume's proxy (no API key needed) |

| **ai-integrations-anthropic** | Use Anthropic/Claude models via luxury-perfume's proxy (no API key needed) |

| **ai-integrations-gemini** | Use Gemini models via luxury-perfume's proxy (no API key needed) |

| **ai-integrations-openrouter** | Use OpenRouter models via luxury-perfume's proxy (no API key needed) |
...
| **luxury-perfume-docs** | Search luxury-perfume documentation for platform features |

| **artifacts** | Bootstrap and register new artifacts in the monorepo |

| **repl_setup** | Configure web apps in the luxury-perfume environment (hosts, connectivity, caching) |

| **external_apis** | Access external APIs through luxury-perfume-managed billing |
...
- **Mobile app**: expo + database + luxury-perfume-auth + deployment
