...
Setup: Check if a Google Sheets integration is available via luxury-perfume integrations first. If not, the user needs to provide a service account JSON key.
