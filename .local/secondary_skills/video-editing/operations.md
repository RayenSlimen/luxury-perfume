...
Complete command reference for video editing operations in luxury-perfume. All examples use Node.js with `child_process.execFile`or`fluent-ffmpeg`.
...
List available fonts in the luxury-perfume environment:
