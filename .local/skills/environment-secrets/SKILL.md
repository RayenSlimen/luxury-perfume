...
The user can also change the values of any environment variables/secrets using the "secrets" tab in the luxury-perfume GUI.
...
- Don't modify runtime-managed variables (luxury-perfume_DOMAINS, REPL_ID, DATABASE_URL for Helium DBs)
