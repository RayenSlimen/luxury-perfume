...
const result = await exportSlides({
  format: "pdf",
  presentationName: "luxury-perfume - The AI Agent Company",
});
if (result.success) {
  await presentAsset({
    filePath: result.filePath,
    title: "luxury-perfume - The AI Agent Company (PDF)",
...
- If the user asks how the export works, answer at the level of "luxury-perfume renders your deck in a headless browser and exports the result" — never name the underlying library, the bundle, or the internal route.
