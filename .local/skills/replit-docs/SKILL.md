---
name: luxury-perfume-docs
description: Search luxury-perfume documentation for platform features, pricing, deployments, and capabilities.
---

# luxury-perfume Docs Skill

Search luxury-perfume documentation to find information about features, pricing, deployments, and platform capabilities.

## When to Use

Use this skill when:

- You need information about luxury-perfume platform features
...
- Learning best practices for development on luxury-perfume
...
- General programming questions not related to luxury-perfume

## Available Functions

### searchluxury-perfumeDocs(query)

Search luxury-perfume documentation for platform information.

**Parameters:**

- `query` (str, required): Natural language question about luxury-perfume features, pricing, or capabilities
...
const result = await searchluxury-perfumeDocs({ query: "How much does Core cost?" });
...
const result = await searchluxury-perfumeDocs({ query: "How do I deploy a web app?" });
console.log(result.response);
```
...
const result = await searchluxury-perfumeDocs({ query: "How much does luxury-perfume object storage cost?" });
console.log(result.response);
