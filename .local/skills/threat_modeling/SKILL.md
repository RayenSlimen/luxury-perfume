...
Read the codebase, `luxury-perfume.md`, and any existing `threat_model.md`. Identify:
...
If memory files exist like luxury-perfume.md or .agent/memory, don't repeat the same information.
...
and purchase items. Deployed on luxury-perfume with luxury-perfume Auth for user authentication.
...
Users authenticate via luxury-perfume Auth. The application must validate the authentication
