# `@luxury-perfume/revenuecat-sdk` SDK Docs
...
```ts
import { createClient } from '@luxury-perfume/revenuecat-sdk/client';
import { listProjects, getCustomer } from '@luxury-perfume/revenuecat-sdk';
...
```ts
import type { Customer, Project, GetCustomerData } from '@luxury-perfume/revenuecat-sdk';
```
