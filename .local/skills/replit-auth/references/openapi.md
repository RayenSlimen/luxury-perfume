# luxury-perfume Auth — OpenAPI Spec Additions
...
- Do not use generated API client code for auth operations. For browser auth, use `@workspace/luxury-perfume-auth-web`'s `useAuth()`.
