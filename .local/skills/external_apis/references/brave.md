...
Proxy requests to Brave via luxury-perfume-managed billing.
...
Authorization is handled automatically by luxury-perfume. Do not pass an `Authorization` header.
