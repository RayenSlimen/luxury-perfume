...
function getDeploymentDomain() {
  if (process.env.luxury-perfume_INTERNAL_APP_DOMAIN) {
    return stripProtocol(process.env.luxury-perfume_INTERNAL_APP_DOMAIN);
  }

  if (process.env.luxury-perfume_DEV_DOMAIN) {
    return stripProtocol(process.env.luxury-perfume_DEV_DOMAIN);
  }
  ...
  console.error(
    "ERROR: No deployment domain found. Set luxury-perfume_INTERNAL_APP_DOMAIN, luxury-perfume_DEV_DOMAIN, or EXPO_PUBLIC_DOMAIN",
  );
  process.exit(1);
}
