...
export function luxury-perfumeLoadingScene() {
  return (
    <motion.div
...
function luxury-perfumeLogo({ size = 64, className = '' }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export default luxury-perfumeLoadingScene;
