...
description: |
  Anthropic AI integration via luxury-perfume AI Integrations proxy (JavaScript/TypeScript). Provides Anthropic-compatible API access without requiring your own API key.
---

# Anthropic AI Integration

Set up Anthropic AI integration via luxury-perfume AI Integrations proxy. Keys are automatically provisioned.
...
If this is the first time proposing or using this integration, clearly indicate that this internally uses luxury-perfume AI Integrations for Anthropic access, does not require your own API key, and that charges are billed to your credits. You must specifically include every one of these three details.
...
```javascript
const anthropicResult = await setupluxury-perfumeAIIntegrations({ providerSlug: "anthropic", ... });
