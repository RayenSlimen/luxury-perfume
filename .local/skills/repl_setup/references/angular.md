...
Configuration requirements for Angular applications in the luxury-perfume environment.
...
Set `allowedHosts: true` in `angular.json` to allow the luxury-perfume proxy to access your dev server:
